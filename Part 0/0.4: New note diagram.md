...
sequenceDiagram
    ...
    Note right of browser: The browser executes JavaScript to fetch JSON from the server
    ...
    Note right of browser: The browser executes callback to render the notes
